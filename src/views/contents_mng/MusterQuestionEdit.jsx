...
const MusterQuestionEdit = () => {
  ...
  const { mutate: saveData } = useMutation(
    (data) =>
      request.put(`/admin/content-management/muster-question`, data),
    {
      onSuccess: () => {
        alert('저장되었습니다.')
        navigate('/muster_question')
      },
      onError: (e) => {
        console.log(e)
      },
...
export default MusterQuestionEdit
