...
const CompetQuestion = () => {
    const onlineBasicCurTab = sessionStorage.getItem('competQuestionCurTab') == null ? '수학 올림피아드' : sessionStorage.getItem('competQuestionCurTab')
          ...
          <div className="flex items-center gap-3">
            ...
            <select
                ...
                onChange={(e) => {
                  ...
                  sessionStorage.setItem('competQuestionCurTab',e.target.selectedOptions[0].innerText)
                }}
              >
                  <option val="0">수학 올림피아드</option>
                  <option val="1">물리대회</option>
                  <option val="2">중학생 화학대회</option>
              </select>
            </div>
            <div className="flex ml-auto gap-2">
              <Link to="/compet_question/edit">
