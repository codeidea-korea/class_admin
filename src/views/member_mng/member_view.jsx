...
import { convertBirthdayStr, userAuthorityName, userSchoolYear, userStatusName } from '@/components/helpers'
  ...
  return (
    <React.Fragment>
      ...
      <div className='flex mt-5 justify-center gap-3'>
        ...
        <Link to={`/member_edit/${id}`}>
          <button className='btn w-24 btn-sky'>수정</button>
        </Link>
      </div>
      {/* button 끝*/}
      {/* END: Page Layout */}
