...
import { Lucide, Modal, ModalBody, ModalFooter, ModalHeader, Notification } from '@/base-components'
...
import { userSchoolYear, userStatusColorClass, userStatusName } from '@/components/helpers'
...
function MemberMng() {
  ...
  const getUserList = async (rstat = '') => {
    ...
    if (rstat === 'reset') {
      ...
      if (searchParams.fieldName !== '') params += `&fieldName=${searchParams.fieldName}`
  ...
  }, [pageParams.currentPage, searchParams.schoolYear, searchParams.grade, searchParams.linkYN, searchParams.status, searchParams.fieldName])
    ...
    <React.Fragment>
      ...
      <div className='intro-y box mt-5'>
        <div className='p-3 px-5 flex items-center border-b border-slate-200/60'>
          ...
          <button className='btn ml-2' title='초기화' onClick={() => {
            getUserList('reset')
          }}>
          ...
          <div className='ml-auto'>
            <div className='flex flex-middle gap-3'>
              ...
              />
              <button type='button' className='btn btn-primary flex items-center' onClick={() => {
                getUserList()
              }}>
        ...
        <div className='intro-y p-5'>
          ...
          {!!alertText.alertSelUserRemove[0] &&
            <span className='text-sm text-danger mt-2 ml-2'>{alertText.alertSelUserRemove[1]}</span>}
        </div>
      </div>
