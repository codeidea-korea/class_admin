										...
										<div className="border p-5 mt-2 rounded-md">
											...
											<div className="mt-3 border-t pt-3">
												...
												<div className={isOpen ? "show-menu" : "hide-menu"}>
													<div className="bg-slate-100 p-3 mt-2 rounded-md text-slate-500 h-80 overflow-y-auto agree_box" >
														<h4>WP Apply 이용약관</h4>
                                                        <h5>제 1장 총칙</h5>
                                                        <h6>제 1조 (목적)</h6>
                                                        <p>
                                                            본 이용약관(이하 “약관”)은 ㈜ 이트리즈 과사람학원(이하 “회사”)과 이용 고객(이하 “회원”)간에 웹사이트 및 응용프로그램을 통해 회사가 제공하는 ㈜ 이트리즈과사람 및 연계된 브랜드 서비스(이하 “서비스”)의
                                                            가입 조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
                                                        </p>
														<h6>제 2조 (이용약관의 효력 및 변경)</h6>
														<p>본 약관은 서비스를 이용하고자 하는 모든 회원에 대하여 그 효력을 발생합니다.
															본 약관은 서비스 홈페이지에 온라인으로 공시됨으로써 효력이 발생되고, 합리적인 사유가 발생할 경우 회사는 관계법령에 위배되지 않는 범위에서 본 약관을 변경할 수 있습니다.
															개정 약관은 서비스 홈페이지에 온라인으로 공시됨으로써 효력이 발생됩니다. 회사는 약관을 변경할 경우 지체 없이 이를 공시하여야 하고, 회원의 권리나 의무 등에 관한 중요사항을 개정할 경우에는 사전에 공시하여야 합니다.
															본 약관에 동의하는 것은 정기적으로 서비스 홈페이지를 방문하여 약관의 변경사항을 확인하는 것에 동의함을 의미합니다. 변경된 약관을 인지하지 못해 발생하는 이용자의 피해에 대해서 회사에서는 책임지지 않습니다.
															변경된 약관에 동의하지 않는 회원은 탈퇴(해지)를 요청할 수 있으며, 약관의 공시된 날로부터 7일 이내 별도의 이의 제기 및 거부의사를 표시하지 아니하고 서비스를 계속 사용할 경우는 약관에 동의한 것으로 간주됩니다.
														</p>
														<h6>제 3조 (약관과 기타 준칙)</h6>
														<p>
															본 약관은 회사가 제공하는 개별서비스에 관한 이용안내(이하 서비스별 안내라 함)와 함께 적용됩니다. 본 약관에 명시되지 아니한 사항은 관계법령 및 서비스별 안내로 갈음합니다.
														</p>
														<h6>제 4조 (용어 정의)</h6>
														<p>
															“회원”은 “회사”에서 제공하는 각각의 브랜드 서비스에 개인정보를 제공하여 회원등록을 한 자로서, “회사”가 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.
															“아이디(ID)”라 함은 “회사”에서 제공하는 서비스를 이용하기 위하여 회원이 정하고 회사가 승인하는 문자와 숫자의 조합을 의미합니다.
															“비밀번호”라 함은 “회원”임을 확인하고 비밀 보호를 위해 “회원”에게 부여된 “아이디”와 일치하는 “회원” 자신이 정한 영문, 숫자 또는 특수문자 등의 조합을 의미합니다.
															“서비스 홈페이지”라 함은 “회원”이 온라인으로 “회사”에서 운영하는 위피어플라이 및 연계된 브랜드 서비스를 이용할 수 있는 당사의 인터넷 사이트를 의미합니다.
															“브랜드 서비스”란 “회사”가 제공하는 모든 서비스를 의미하며 위피어플라이 웹사이트 도메인과 각 브랜드의 개별적인 도메인, 그리고 응용 프로그램으로 제공될 수 있습니다.
															브랜드 서비스의 추가 변경사항은 위피어플라이 웹사이트를 통해 고지합니다.
														</p>
                                                        <h5>제 2장 이용계약 체결</h5>
														<h6>제 5조 (이용 계약의 성립)</h6>
														<p>
															이용 계약은 “회원”이 본 약관에 대한 동의와 이용신청에 대하여 회사가 이용승낙을 함으로써 성립하며, 본 이용약관에 대한 동의절차는 “회사는” 서비스 이용 신청 화면에 게시하고. “회원”은 본 약관과 동의 절차에 대하여 인지하고 신청을 완료함으로써 성립합니다.
														</p>
														<h6>제 6조 (서비스 이용 신청)</h6>
														<p>
															회원으로 가입하여 본 서비스를 이용하고자 하는 자는 회사에서 요청하는 제반 정보(이름, 연락처 등)를 제공하여야 합니다.
															모든 회원은 반드시 회원 본인의 이름을 제공하여야만 서비스를 이용할 수 있으며, 실명으로 등록하지 않는 자는 일체의 권리를 주장할 수 없으며, 만일 제 3의 명의 도용 및 부정한 방법으로 이용하는 경우에는 관련법령에 의해 처벌 받을 수 있습니다.
														...
														<p>
															...
															회사는 별도의 이벤트 및 마케팅 활동과 기타 “회사”에서 제공하는 서비스를 이용하기 위한 과정에서 수집되는 개인정보를 활용하여 서비스 안내 및 경품 제공 동의 마케팅 활용을 할 수 있으며, 이용약관에 명시된 서비스 제공을 위한 목적으로만 사용합니다.
															...
															회사는 회원에게 제3항의 전문적이고 다양한 서비스를 제공하기 위해 자체적으로 TM을 하거나, 외부 전문 사업자와 제휴하여 공동으로 마케팅 서비스(TM, SMS, 메일 등 광고성 정보 발송)를 제공할 수 있습니다.
															전문적인 지식, 경험과 상담이 요구되는 서비스의 경우 회원의 동의를 받아 외부전문사업자와 공동으로 서비스를 제공하며 이때 해당전문사업자의 상호와 공유목적, 공유 정보를 명시합니다.
															외부전문사업자와의 공동서비스를 제공함에 있어 회원의 성명, 연락처 등 공동서비스에 필요한 최소한의 정보가 공유될 수 있고, 공유되는 정보는 아래 각호와 같이 엄격히 보호 관리됩니다.<br/>
															① 공유되는 정보는 해당 전문 서비스 이외 어떠한 다른 용도로도 사용되지 않습니다.<br/>
															② 서비스 제공 과정에서 해당 전문 서비스에 대해 회원이 동의의사를 밝히지 않거나 사전에 거부의사를 밝힐 경우 최소한의 정보도 전문 사업자와 공유하지 않습니다.<br/>
															<br/>
															제 4항의 개인정보 이용에 관한 회원의 동의는 본 약관에 동의하는 것으로 갈음할 수 있습니다. 회원은 언제든 원할 경우 회사에 제공한 개인정보의 수집과 이용에 관한 동의를 철회할 수 있고, 위 동의의 철회는 해지 신청을 하는 것으로 이루어집니다.
															개인정보보호와 관련된 보다 자세한 사항은 개인정보취급방침을 참고하시기 바랍니다.

														</p>
														<h6>제 9조 (이용 신청의 승낙과 제한)</h6>
														<p>
															회사는 제6조의 규정에 의한 이용신청고객에 대하여 업무 수행상 또는 기술상 지장이 없는 경우 원칙적으로 접수순서에 따라 서비스 이용을 승낙합니다. 회사는 아래사항에 해당할 경우 이용 승낙하지 않을 수 있습니다.<br/>
														...
														<p>
															...
															회원 ID 및 비밀번호의 관리책임은 이용자에게 있고, 그 관리책임을 소홀히 하여 발생하는 서비스 이용상의 손해나 제 3자에 의한 부정이용 등의 책임은 전적으로 이용자가 부담하여야 합니다.
														...
														<h6>제 12조 (이용자의 의무)</h6>
														<p>
															이용자는 회원가입신청이나 회원정보변경 시 모든 사항을 사실에 근거해 작성하여야 하며, 허위 또는 타인의 정보를 이용하여 등록할 경우에는 ‘회원’으로서의 일체의 권리를 주장할 수 없습니다.
															...
															⑤ 회사로부터 특별한 권리를 부여 받지 않고 회사의 응용프로그램을 변경하거나, 회사의 서버를 해킹하거나, 웹사이트 또는 게시된 정보의 일부분 또는 전체를 임의로 변경하는 행위<br/>
															⑥ 회사에서 제공하는 서비스에 위해를 가하거나 고의로 방해하는 행위<br/>
															⑦ 본 서비스를 통해 얻은 정보를 회사의 사전 승낙 없이 서비스 이용 되의 목적으로 복제하거나, 이를 출판 및 방송 등에 사용하거나, 제 3자에게 제공하는 행위<br/>
														...
														<p>
															서비스 화면 내에 게시한 게시물의 저작권은 게시한 회원에게 귀속됩니다. 만일 위 게시물이 제 3자의 지적재산권을 침해할 경우의 모든 책임은 게시물을 게시한 회원이 부담하며, 이로 인해 회사가 타인으로부터 손해배상청구 등을 받게 될 경우 회원은 회사의 면책을 위해 노력해야 하고, 회사가 면책되지 않을 경우 회사의 모든 손해를 배상하여야 한다.
														...
														<p>
															...
															상기 이용제한 규정에 따라 서비스를 이용하는 회원에게 서비스 이용에 대하여 별도 공지 없이 서비스 이용의 일시정지, 초기화, 이용계약 해지 등을 불량이용자 처리규정에 따라 취할 수 있습니다.
															회사는 회원 자격을 제한, 정지시킨 후, 동일한 행위가 2회 이상 반복되거나 30일 이내에 그 사유가 시정되니 아니하는 경우 회사는 회원 자격을 상실시킬 수 있습니다.
														...
														<p>
															...
															회사는 이용자의 컴퓨터 오류에 의해 손해가 발생한 경우, 또는 회원이 신상정보 및 전자우편주소를 부실하게 기재하여 손해가 발생한 경우 책임을지지 않습니다.<br/>
															회사는 회원이 서비스를 이용하여 기대하는 수익을 얻지 못하거나 상실한 것에 대하여 책임을지지 않습니다.<br/>
															회사는 회원이 서비스를 이용하면서 얻은 자료로 인한 손해에 대하여 책임을지지 않습니다. 또한 회사는 회원이 서비스를 이용하며 타 회원으로 인해 입게 되는 정신적 피해에 대하여 보상할 책임을지지 않습니다.<br/>
											...
											<div className="mt-3 border-t pt-3">
												...
												<div className={isOpen2 ? "show-menu" : "hide-menu"}>
													<div className="bg-slate-100 p-3 mt-2 rounded-md text-slate-500 h-80 overflow-y-auto agree_box" >
														<h5>개인정보처리방침</h5>
														<p>
															㈜ 이트리즈 과사람(이하 “회사”라 합니다)는 정보주체의 자유와 권리 보호를 위해 「개인정보보호법」 및 관계 법령이 정한 바를 준수하여, 적법하게 개인 정보를 처리학 안전하게 관리하고 있습니다.
															이에 「개인정보 보호법」 제 30조에 따라 정보주체에게 개인정보 처리에 관한 절차 및 기준을 안내하고, 이와 관련된 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을 수립·공개합니다.
														</p>
														<h6>제 1조 (개인 정보의 수집에 대한 동의)</h6>
														<p>
														회사는 개인정보처리방침의 내용에 대하여 「동의」할 수 있는 절차를 마련하여, 회원이 「동의」 버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 간주합니다. 단, 학부모가 자녀를 추가로 가입하는 경우 학부모가 「동의」 버튼을 선택하면 자녀의 개인정보 수집에 대해 동의한 것으로 간주합니다.
														</p>
														...
														<p>
															...
															○ 회원 가입<br/>
															- 회원제 서비스 이용에 따른 본인확인, 개인식별, 불량 회원의 부정 이용 방지와 비인가 사용 방지, 가입 의사 확인, 연령 확인, 학사 기록 관리, 만 14세 미만 아동 개인정보 수집 시 법정 대리인 동의 여부 확인, 불만 처리 등 민원처리, 고지사항 전달<br/>
															○ 방문 상담, 테스트 및 수강 신청<br/>
															- 강의 등록 및 서비스 제공, 고지사항 전달, 학사기록 관리, 이벤트 참여, 민원처리, 환불 접수, 수준 테스트 및 과정 맞춤형 컨설팅, 고객 상담 등<br/>
															○ 서비스 제공에 관한 계약 이행<br/>
															- 강의 및 콘텐츠 제공, 교육서비스 제공 사실 확인, 수업환경 모니터링, 강의자료 활동<br/>
															○ 기록 보존<br/>
															- 학원법 시행규칙 제 17조에 따른 기록보관<br/>
															○ 홍보 및 마케팅, 광고 (홍보, 마케팅 동의 시)<br/>
															- 수상 및 합격 사실 공개 등을 통한 홍보와 마케팅, 신규 서비스(제품)개발 및 특화, 이벤트 등 광고성 정보 전달, 접속 빈도 파악, 회원의 서비스 이용에 대한 통계
														</p>
														...
														<p>
															...
															① 약관 및 정책에 따라 서비스 이용의 혼성, 부정 이용방지, 불법적 사용자에 대한 관련 기관 수사협조를 위하여 회원탈퇴 후 1년간 개인 정보를 보존하며, 이 기간이 경과한 후에 삭제합니다.<br/>
															② 회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체없이 파기합니다. 단 다음의 정보에 개해서는 아래의 이류로 명시한 기간 동안 보존합니다.<br/>
															1. 로그인 ID<br/>
														...
														<p>
															...
															② 권리 행사는 회사에 대해 「개인정보 보호법」 시행령 제 41조 제 1항에 따라 서면, 전자우편, 모사전성(FAX) 등을 통하여 하실 수 있으며, 회사는 이에 대해 지체없이 조치하겠습니다.<br/>
															③ 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 “개인정보 처리 방법에 관한 고시(제2020-7호)” 별지 제 11호 서식에 따른 위임장을 제출하여셔야 합니다.<br/>
															...
															⑦ 개인 정보 조회, 수정을 위해서는 “개인정보 변경”(또는 “회원정보수정” 등)을, 가입 해지(동의 철회)를 위해서는 “회원탈퇴”를 클릭하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다.
														</p>
														<h6>제 6조 (개인정보의 안정성 확보조치)</h6>
														<p>
															회사는 개인정보의 안정성 확보를 위해 다음과 같은 조치를 취하고 있습니다.<br/>
															① 관리적 조치 : 내부관리계획 수립, 시행, 정기적 직원 교육 등<br/>
															② 기술적 조치 : 개인정보처리시스템 등의 접근 권한 관리, 접근 통제시스템 설치, 고유식별정보 등의 암호화, 보안프로그램 설치(백신 프로그램 포함) 및 갱신<br/>
