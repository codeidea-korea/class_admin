        ...
        <div className="p-5">
          <table className="table table-bordered">
            ...
            <tr className="text-center">
              <td className="bg-slate-50">1학년</td>
              <td></td>
              <td></td>
              <td></td>
              <td></td>
      ...
      <div className="intro-y mt-5 box">
        ...
        <div className="p-5">
          <table className="table table-bordered">
            ...
            <tr className="text-center">
              <td className="bg-slate-50 font-medium w-52">1학년(1학기)</td>
              <td></td>
              <td></td>
              <td></td>
            </tr>
            <tr className="text-center">
              <td className="bg-slate-50 font-medium">1학년(1학기)</td>
              <td></td>
              <td></td>
              <td></td>
            </tr>
      ...
      <div className="intro-y mt-5 box">
        ...
        <div className="px-5 pb-5">
          <table className="table table-bordered">
            ...
            <tr className="text-center">
              <td className="bg-slate-50 font-medium">2학년</td>
              <td></td>
              <td></td>
            </tr>
            <tr className="text-center">
              <td className="bg-slate-50 font-medium">3학년</td>
              <td></td>
              <td></td>
            </tr>
          </table>
      ...
      <div className="intro-y mt-5 box">
        ...
        <div className="p-5">
          <table className="table table-bordered">
            ...
            <tr className="text-center">
              <td className="bg-slate-50 font-medium">-</td>
              <td></td>
              <td></td>
              <td></td>
              <td></td>
