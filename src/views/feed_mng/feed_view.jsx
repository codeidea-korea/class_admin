            ...
            >
              <div className="intro-y grid grid-cols-12 gap-6">
                <div className="col-span-8">
                  ...
                  <div className="bg-slate-100 p-5 rounded-md mt-3">
                    ...
                    när ånt poskap. Foliehatt desk. Plafadade öledes semikyliga,
                    spegt om plaspell. Exonas makror mikengar. Stuprörspolitik
                    plabel. Gik makrogt, att pren om än apotris om Odellplatta.
                    Trelig potör. Gensax tregt i prebel.
                    <br />
                    <br />
                    <span
                      style={{
                    ...
                    >
                      Kande brattig. Kode kavis. Nyskade trenygt men transtos i
                      nysement som poling. Zlatanera nens. Sanera global hektar
                    </span>
                  </div>
              ...
              <div className="intro-y grid grid-cols-12 gap-6">
                <div className="col-span-8">
                  <div className="flex justify-between items-center gap-6">
                    <div className=" text-base font-medium">
                      2. 지원 학생(본인) 의 진로계획을 구체적으로 서술해 보세요.
                    </div>
                    <button className="btn btn-green btn-sm shrink-0">
                      피드백 달기
                    </button>
                  ...
                  <div className="bg-slate-100 p-5 rounded-md mt-3">
                    Lörem ipsum krodinock tres vasade. Heminoning. Vavis anande
                    hall då gigahet att rediligt. Multiss kreddig. Jining
                    autorar när ånt poskap. Foliehatt desk. Plafadade öledes
                    semikyliga, spegt om plaspell. Exonas makror mikengar.
                    Stuprörspolitik plabel. Gik makrogt, att pren om än apotris
                    om Odellplatta. Trelig potör. Gensax tregt i prebel.
                    <br />
                    <br />
                    <span
                      style={{
              ...
              <div className="intro-y grid grid-cols-12 gap-6">
                <div className="col-span-8">
                  <div className="flex justify-between items-center gap-6">
                    <div className=" text-base font-medium">
                      3. 지원 학생(본인) 의 장점과 특기 사항을 구체적으로 서술해
                      보세요.
                    </div>
                    <button className="btn btn-green btn-sm shrink-0">
                      피드백 달기
