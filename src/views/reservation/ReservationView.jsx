      ...
      <div className='intro-y box mt-5'>
        ...
        <div className='p-5'>
          <table className='table table_layout01'>
            ...
            <tr>
              <td className='w-48'>
                <span className='text-slate-400 font-bold'>유형</span>
              </td>
              <td>{reservations.authority === 'PARENTS' ? '학부모' : reservations.authority === 'STUDENT' ? '학생' : reservations.authority === null ? '비회원' : reservations.authority}</td>
            </tr>
            <tr>
              <td className='w-48'>
